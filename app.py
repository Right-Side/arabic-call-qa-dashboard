...
# ─────────────────────────────────────────────
st.set_page_config(
    page_title="Arabic Call QA Dashboard",
    page_icon="📞",
    layout="wide",
...
def build_system_prompt(department: str, dialect: str, kpis: str) -> str:
    return f"""You are an expert Quality Assurance Auditor specialising in Arabic-language call centres.
...
with st.sidebar:
    ...
    st.markdown("*Arabic Call Analytics*")
    st.divider()
...
<div class="hero-banner">
    <h1>📞 Arabic Call QA Dashboard</h1>
